      ...
      {surfaceValues.curvature === "flat" && (
        <Fragment>
          ...
          <p>
            ...
            surface from the specified shape across the clear aperture, in units
            of λ/N, where λ=632.8nm
            <br />
            <br />
            ...
            <br />
            <br />
            Surface Roughness: Root mean square variation of the optical surface
            with respect to the specified shape across the clear aperture
          </p>
        </Fragment>
      )}
